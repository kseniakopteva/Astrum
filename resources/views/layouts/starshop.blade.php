<x-main-layout>
    <div class="max-w-7xl m-auto bg-white p-6 dark:bg-neutral-800">
        <div class="flex justify-between items-center mb-6 pb-6 border-b border-neutral-300 dark:border-neutral-700">
            <h1 class="large-title"><a href="{{ route('starshop') }}">Star <i class="fa-solid fa-star"></i> Shop</a></h1>
            <nav>
                <ul class="flex space-x-4">
                    <x-starshop-nav-button :href="route('starshop.wallpapers')" :active="request()->routeIs('starshop.wallpapers') || request()->routeIs('starshop')">Wallpapers</x-starshop-nav-button>
