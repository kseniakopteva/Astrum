<x-main-layout>
    ...
    @endpush
    <div class="wrapper">
        <div class="mt-6 mx-auto" id="wrapper">
...
<script>
    window.onload = function() {
        ...
        console.log(localStorage.getItem('feed_view'));

        if (localStorage.getItem('feed_view') === null || localStorage.getItem("feed_view") === 'list') {

            gridIcon.style.display = 'none';
            listIcon.style.display = 'block';
            document.getElementById('wrapper').classList.add('max-w-xl');
            ...
            document.getElementById('wrapper').classList.remove('max-w-xl');
