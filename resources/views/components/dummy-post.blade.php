@props(['post_frame', 'col_start_2' => true])
...
<article
    ...
    class="@if ($col_start_2) col-start-2 col-span-3 @endif first-letter:flex flex-col justify-between border bg-white border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700 rounded-lg p-4 pt-4 mb-4 break-inside-avoid">
    <div class="">
        <a class="">
