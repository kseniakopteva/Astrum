                ...
                <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data" class="space-y-2">
                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            ...
                            <select name="type" id="type" onchange="checkSelectedType(this)" class="cursor-pointer flex-grow my-2 border-neutral-300 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-300 focus:border-lime-500 dark:focus:border-lime-600 focus:ring-lime-500 dark:focus:ring-lime-600 rounded-md">
                    ...
                    <div id="slots" style="display: block">
                        <div class="flex items-center gap-3">
                            ...
                            <input type="number" name="max_slots" id="max_slots" value="{{ old('max_slots') }}" class="block border-neutral-300 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-300 focus:border-lime-500 dark:focus:border-lime-600 focus:ring-lime-500 dark:focus:ring-lime-600 rounded-md">
