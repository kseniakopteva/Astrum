<x-starshop-layout>
    <div class="max-w-xl m-auto mb-6">
        ...
        <form action="{{ route('starshop.wallpapers.store') }}" method="POST" class="space-y-2" enctype="multipart/form-data">
            @csrf
            ...
            <div>
                ...
                <x-textarea id="description" name="description" class="w-full" required>{{ old('description') }}
                </x-textarea>
